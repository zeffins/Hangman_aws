...
const Home = ({ setDifficulty }) => {
  const handleDifficultyClick = (difficulty) => {
    setDifficulty(difficulty); // Update the difficulty in the parent
  };

  return (
    <div className="home">
      <div className="home-content">
        <h1 className="home-main-txt">HANGMAN</h1>
        <p style={{ fontWeight: '500' }}>START GAME</p>
      ...
      <div>
        <img src={hangman} alt="..." className="hangman-img" />
      </div>
    </div>
  );
};
